const UserIcon = () => {
  return (
    <>
    <svg className="w-8 h-8 rounded-full" data-slot="icon" fill="none" strokeWidth="1.5" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">

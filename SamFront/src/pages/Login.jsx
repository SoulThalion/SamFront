...
<div className="flex flex-col justify-center items-center min-h-screen bg-black">
    ...
    <form className="w-full max-w-md bg-242529 rounded-lg p-6 border border-58aaae">
        <div className="mb-4">
        ...
        <div className="flex justify-center">
            <button type="submit" onSubmit={handleLogin} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-20 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
        </div>
    </form>
</div>
